...
export const PATIENTS_DATA = {
  default: {
    stats: [
      ...
      { title: 'بدأ العلاج اليوم', stat: '201',   description: 'المرضى الذين بدأوا العلاج اليوم' },
      { title: 'انتهى العلاج اليوم',  stat: '120',   description: 'المرضى الذين انتهى علاجهم اليوم'   },
    ...
    status: [{ name:'بدأ العلاج',value:290},{ name:'حرج',value:47},{ name:'انتهى العلاج',value:120}],
    nationality: [{ name:'مصري',value:380},{ name:'سعودي',value:25},{ name:'سوداني',value:18},{ name:'سوري',value:12},{ name:'أخرى',value:22}],
  },
  cairo: {
    stats: [
      { title: 'إجمالي المرضى',   stat: '3,812', description: 'جميع المرضى المسجلين'       },
      { title: 'بدأ العلاج اليوم', stat: '87',    description: 'المرضى الذين بدأوا العلاج اليوم' },
      { title: 'انتهى العلاج اليوم',  stat: '54',    description: 'المرضى الذين انتهى علاجهم اليوم'   },
    ...
    status: [{ name:'بدأ العلاج',value:120},{ name:'حرج',value:21},{ name:'انتهى العلاج',value:54}],
    nationality: [{ name:'مصري',value:165},{ name:'سعودي',value:10},{ name:'سوداني',value:8},{ name:'سوري',value:5},{ name:'أخرى',value:7}],
  },
  giza: {
    stats: [
      { title: 'إجمالي المرضى',   stat: '2,145', description: 'جميع المرضى المسجلين'       },
      { title: 'بدأ العلاج اليوم', stat: '51',    description: 'المرضى الذين بدأوا العلاج اليوم' },
      { title: 'انتهى العلاج اليوم',  stat: '29',    description: 'المرضى الذين انتهى علاجهم اليوم'   },
    ...
    status: [{ name:'بدأ العلاج',value:75},{ name:'حرج',value:11},{ name:'انتهى العلاج',value:29}],
    nationality: [{ name:'مصري',value:92},{ name:'سعودي',value:7},{ name:'سوداني',value:5},{ name:'سوري',value:3},{ name:'أخرى',value:6}],
  },
  alexandria: {
    stats: [
      { title: 'إجمالي المرضى',   stat: '2,680', description: 'جميع المرضى المسجلين'       },
      { title: 'بدأ العلاج اليوم', stat: '63',    description: 'المرضى الذين بدأوا العلاج اليوم' },
      { title: 'انتهى العلاج اليوم',  stat: '37',    description: 'المرضى الذين انتهى علاجهم اليوم'   },
    ...
    status: [{ name:'بدأ العلاج',value:95},{ name:'حرج',value:15},{ name:'انتهى العلاج',value:37}],
    nationality: [{ name:'مصري',value:123},{ name:'سعودي',value:8},{ name:'سوداني',value:5},{ name:'سوري',value:4},{ name:'أخرى',value:9}],
  },
}
...
export const PHARMACY_DATA = {
  default: {
    ...
    topDrugs: [{ name:'باراسيتامول',value:210},{ name:'أموكسيسيلين',value:169},{ name:'إيبوبروفين',value:133},{ name:'ميتفورمين',value:113},{ name:'أخرى',value:61}],
  ...
  cairo: {
    ...
    topDrugs: [{ name:'باراسيتامول',value:90},{ name:'أموكسيسيلين',value:72},{ name:'إيبوبروفين',value:56},{ name:'ميتفورمين',value:48},{ name:'أخرى',value:27}],
  ...
  giza: {
    ...
    topDrugs: [{ name:'باراسيتامول',value:52},{ name:'أموكسيسيلين',value:42},{ name:'إيبوبروفين',value:33},{ name:'ميتفورمين',value:28},{ name:'أخرى',value:15}],
  ...
  alexandria: {
    ...
    topDrugs: [{ name:'باراسيتامول',value:68},{ name:'أموكسيسيلين',value:55},{ name:'إيبوبروفين',value:44},{ name:'ميتفورمين',value:37},{ name:'أخرى',value:19}],
